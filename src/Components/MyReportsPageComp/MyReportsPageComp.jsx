...
//     },
//     descriptionBoxes: [
//       { id: 1, text: "این گزارش عملکرد ماهانه شما را نشان می‌دهد." },
//     ],
//     date: "1403/12/01",
//   },
//   {
...
//     chartType: "line",
//     filters: { type: "exam_comparison" },
//     data: {
//       labels: ["آزمون 1", "آزمون 2", "آزمون 3"],
//       datasets: [
//         {
//           label: "درصد موفقیت",
//           data: [70, 85, 60],
...
//     },
//     descriptionBoxes: [
//       { id: 1, text: "مقایسه نتایج آزمون‌های اخیر شما." },
//       { id: 2, text: "تحلیل روند پیشرفت." },
//     ],
//     date: "1403/12/05",
//   },
// ];
...
// const MyReportsPageComp = () => {
//   const { reports: dynamicReports } = useReports(); // گزارش‌های داینامیک از context
//   const [selectedReport, setSelectedReport] = useState("all");

//   // ترکیب گزارش‌های استاتیک و داینامیک
...
const staticReports = [
  ...
  },
  {
      ...
      datasets: [
        {
          ...
          data: [
            57, 62, 67, 72, 52, 77, 42, 47, 37, 57, 32, 62, 52, 47, 37, 27, 5, 59,
            64, 69, 74, 500, 49, 74, 44, 39, 41, 42, 44,
          ],
          backgroundColor: "rgba(75, 192, 192, 0.2)",
          borderColor: "rgba(75, 192, 192, 1)",
          borderWidth: 1,
        ...
        {
          label: "کل ظرفیت درخواستی",
          data: [1594], // ستون تک برای کل
    ...
    descriptionBoxes: [
      {
        id: 1,
        text: "بیشترین ظرفیت درخواستی: شرکت توسعه منابع آب و نیروی ایران با ۵۰۰ نفر (۳۱.۴٪)",
      },
      {
        id: 2,
        text: "کمترین ظرفیت درخواستی: شرکت کاویان سازه آژند با ۵ نفر (۰.۳۱٪)",
      },
    ],
    date: "۱۴۰۳/۱۲/۱۲",
  }
